...
export default function WeeklyCharts() {
  ...
  const loadWeeklyStats = useCallback(async () => {
    try {
      ...
      const url = selectedWeek 
        ? `/api/admin/stats/weekly?weekStart=${selectedWeek}`
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border rounded-lg p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 text-center">
            <div className="text-2xl font-bold text-purple-600">{stats.summary.avgScore}</div>
      ...
      <div className="bg-white border rounded-lg p-6">
        <h3 className="text-lg font-semibold mb-4">📈 Activité par Jour</h3>
      ...
      {/* Tableau détaillé */}
      <div className="bg-white border rounded-lg p-6">
        <h3 className="text-lg font-semibold mb-4">📋 Détails par Jour</h3>
