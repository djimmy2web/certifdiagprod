...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log(`📊 Statistiques hebdomadaires du ${startDate.toLocaleDateString('fr-FR')} au ${endDate.toLocaleDateString('fr-FR')}`);

    // Statistiques des tentatives (quiz terminés)
    ...
    // Statistiques des progressions (quiz en cours)
